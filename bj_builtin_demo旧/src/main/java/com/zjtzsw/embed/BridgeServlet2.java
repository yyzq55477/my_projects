...
public class BridgeServlet2 {
	...
	private static final String[] methods = { "addYx31", "editYx31", "deleteYx31", "addYx06", "editYx06", "deleteYx06", "buildPdf", "removeCategory",
			...
			"fetchImages","putStorageContent","initFileUnit","removeStorageObject", "removePicsByBatch","saveFileUnitForMulti","updateServiceCatalog" };// 有效的方法

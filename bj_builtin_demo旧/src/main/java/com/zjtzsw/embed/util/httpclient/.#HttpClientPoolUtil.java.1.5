...
public class HttpClientPoolUtil {
	...
	/** 
	 * @Description: HttpClient连接池请求处理工厂(get请求处理方法)
	 * @MethodName: httpClientRequest
	 * @Param: [httpResquest, cookie] 
	 * @return: com.tzsw.bj.apps.httpservice.util.HttpResultEntity 
	 * @Author: Franocris
	 * @Date: 2018/7/24 
	 */ 
	public static HttpResultEntity httpClientRequestGet(HttpRequestBase httpRequest, String headCookie){
//			config(httpPost,headCookie);
	 ...
	 * @MethodName: httpClientRequest
	 * @Param: [httpPost, params, cookie] 
	 * @return: com.tzsw.bj.apps.httpservice.util.HttpResultEntity 
	 * @Author: Franocris
	 * @Date: 2018/7/24 
	 */ 
	public static HttpResultEntity httpClientRequestPost(HttpPost httpPost,Map<String, String> params, String headCookie){

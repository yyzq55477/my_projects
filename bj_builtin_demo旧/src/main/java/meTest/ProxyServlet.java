...
//		
//		if("createAndPutStorageObject".equals(params.get("method"))) {
//			// 默认高拍仪操作是安全的
...
//				String urlParam = new String(base64.decodeBase64(params.get("data")), "utf-8");
...
//			result = HttpClientPoolUtil.httpClientRequest(httpRequest,null);
...
//	}
//	
//	public String execRemoteMethod2(String nodeName, String method, HttpMethod httpMethod, Map<String, String> params,
//			final HttpServletRequest request, final HttpServletResponse resp) {
//		if (!isEnable) {
//			System.err.println("+++++++++请求影像系统失败，非有效帐套！+++++++");
//			return "";
...
//		copyRequest(request,httpRequest,isScanOnWeb);
//		HttpResultEntity result = HttpClientPoolUtil.httpClientRequest(httpRequest, null);
//		
//		String res = result.getBody();
//		SpUtils.log("...result-> " + res);
//		return res;

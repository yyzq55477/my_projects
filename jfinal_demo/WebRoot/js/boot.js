...
//miniui
document.write('<script src="' + bootPATH + 'jquery-1.4.4.min.js" type="text/javascript"></sc' + 'ript>');
document.write('<script src="' + bootPATH + 'miniui.js" type="text/javascript" ></sc' + 'ript>');
document.write('<link href="/css/miniui.css" rel="stylesheet" type="text/css" />');

...
Picasa.prototype = {
	...
	createFrame : function() {
		...
		this.frame.innerHTML =
			...
			'		<a href="javascript:void(0);" id="PV_Btn_Graffiti"><i class="fa fa-magic"></i></a>'+
			'	</div>'+
			'</div>';
	...
	rotate : function(clockwise) {
		var id = $(this.selector+':eq('+this.currentNo+')').data('id');
		var obj = getObject(id);
		...
		if (res.success) {
			this.resetImage(getPath(obj.file, res.data.fileName));
			obj.degree = degree % 360;
		}
	},

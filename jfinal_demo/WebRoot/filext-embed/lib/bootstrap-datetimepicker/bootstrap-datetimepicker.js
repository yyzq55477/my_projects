...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		$(document).on('mousedown', function (e) {
			// Clicked outside the datetimepicker, hide it,changed by lsh
	...
	Datetimepicker.prototype = {
		...
		fill: function () {
			...
			for (var i = 0; i < 24; i++) {
				//lsh if (hoursDisabled.indexOf(i) !== -1) continue;
			...
			for (var i = 0; i < 60; i += this.minuteStep) {
				//lsh if (minutesDisabled.indexOf(i) !== -1) continue;
	...
	var DPGlobal = {
		...
		footTemplate:     '<tfoot><tr><th colspan="3" class="today"></th><th colspan="2" class="reset">清除</th><th colspan="2" class="shutdown">关闭</th></tr></tfoot>'
	};
